...
//       'assets/icons/custom_marker.png', // make sure this asset exists
//     );
//   }
...
//       isScrollControlled: true, // 👈 important for full padding control
//       builder: (context) {
//         return SafeArea(
//           child: Padding(
...
//               top: 20,
//               bottom:
//                   MediaQuery.of(context).viewInsets.bottom + 30, // 👈 shift up
//             ),
//             child: Column(
...
//                 Text("Available Spaces: ${_selectedSpot!["available_spaces"]}",
